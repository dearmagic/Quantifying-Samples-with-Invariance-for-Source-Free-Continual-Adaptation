...
parser.add_argument('--dataset', default='office-home/World', type=str)
...
if __name__ == '__main__':
    ...
    for incre_idx in range(total_cls_nums // 10):    # incre_idx 训练次数
        ...
        pred_label_dict, weight_dict = obtain_label_weight(train_loader, pretrained_net, confi_class_idx, total_cls_nums, weight_net)
                ...
                for confi_idx, confi_class in enumerate(confi_class_idx):
                    if this_stage_save_imgs:
                        ...
                        if confi_class_values[confi_idx] >= confi_cls_value[confi_class]:  # 大于或者等于都更新
                            img = get_one_classes_imgs(train_loader, confi_class, pred_label_dict)
